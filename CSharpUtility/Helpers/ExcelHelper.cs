...
{
    /// <summary>
    /// Plain old Excel COM Interop Manipulation
    /// <remark>
    /// Newly recommend way is using EPPLUS.Core
    /// </remark>
    /// </summary>
    class ExcelHelper
    {
        /// <summary>
        /// Does not require installed Excel on Client
        /// </summary>
        class ExcelEPPLUS
        {
            public ExcelEPPLUS()
            {
                ...
                // automatically destroyed after out of scope
        ...
        [Obsolete("Not recommend due to dependency of Excel COM Interop. Use EPPLUS version which does not require installed Excel on Client.", true)]
        class ExcelInterop
        {
